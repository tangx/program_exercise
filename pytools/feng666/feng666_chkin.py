...
def do_setup_json(opener, http_type):
    ...
    import py_setup_config
    py_setup_config.setup_ss_json(user_info, nodes_infos)


def main_feng666(username, password):
...
if __name__ == '__main__':
    ...
    main_feng666(username, password)
